<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AnonymousTokenManager.ascx.cs" Inherits="TokenManagement.AnonymousTokenManager" %>
...
<script runat="server">
    ...
    /// </summary>
    public class AnonymousTokenContext : IDisposable
    {
        private readonly string _visitorId;
        private readonly string _tokenType;
        private bool _disposed;
        
        public AnonymousTokenContext(string visitorId, string tokenType)
        {
    ...
    public static class AnonymousTokenHelper
    {
        ...
        /// </summary>
        public static AnonymousTokenContext CreateTokenContext(string tokenType)
        {
            string visitorId = GetOrCreateVisitorId();
            return new AnonymousTokenContext(visitorId, tokenType);
        }
...
<script runat="server">
    private AnonymousTokenContext _apiTokenContext;
